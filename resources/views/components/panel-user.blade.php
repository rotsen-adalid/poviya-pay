...
<div x-data="setup()" x-init="$refs.loading.classList.add('hidden');" :class="{ 'dark': isDark}">
        ...
        <div
            x-ref="loading"
            class="fixed inset-0 z-50 flex items-center justify-center text-2xl font-semibold text-white bg-transparent " 
        > <!-- bg-opacity-90 -->
            Loading.....
        </div>

    <div class="flex flex-col h-screen antialiased text-gray-900 bg-white dark:bg-dark dark:text-light">
       ...
       <div class="flex">
           ...
           <div class="pt-14">
            ...
            <div class="flex flex-col flex-1 min-h-screen overflow-x-hidden overflow-y-auto pt-14">
            
                <!-- Main content -->
                <div class="h-full sm:p-0">
